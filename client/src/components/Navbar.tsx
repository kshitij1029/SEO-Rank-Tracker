...
import { Search, BarChart3, History, LogOut, Menu, X, Sun, Moon, Target, ChartNoAxesColumnIcon } from "lucide-react";
...
export default function Navbar() {
    ...
    const handleLogout = () => {
        logout();
        setTimeout(() => toast.success("Successfully Logged out"), 500);
        navigate("/");
    };
