                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    ...
                    <div className="bg-card border border-border rounded-2xl p-8 flex flex-col">
                        ...
                        <ul className="space-y-3 mb-8 flex-1">
                            {["5 analyses per day", "Full SEO report", "Issue detection", "Keyword analysis", "Export results"].map((item) => (
                    ...
                    <div className="relative rounded-2xl p-8 flex flex-col bg-card border border-primary/30 overflow-hidden">
                        ...
                        <ul className="space-y-3 mb-8 flex-1">
                            {["Unlimited analyses", "Priority processing","Advanced Tracking", "Historical tracking", "API access", "Email reports"].map((item) => (
                                <li key={item} className="flex items-center gap-2 text-sm text-muted-foreground">
                                    <CheckCircle size={16} className="text-primary shrink-0" />
                                    {item}
                                </li>
